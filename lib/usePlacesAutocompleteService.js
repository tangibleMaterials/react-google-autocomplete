...
function usePlacesAutocompleteService(_ref) {
  ...
  var _useState5 = (0, _react.useState)(false),
      ...
      isScriptLoaded = _useState6[0],
      setIsScriptLoaded = _useState6[1];

  var _useState7 = (0, _react.useState)(null),
      _useState8 = _slicedToArray(_useState7, 2),
      placeInputValue = _useState8[0],
      setPlaceInputValue = _useState8[1];

  var _useState9 = (0, _react.useState)(false),
      _useState10 = _slicedToArray(_useState9, 2),
      isQueryPredsLoading = _useState10[0],
      setIsQueryPredsLoading = _useState10[1];

  var _useState11 = (0, _react.useState)(false),
      _useState12 = _slicedToArray(_useState11, 2),
      queryInputValue = _useState12[0],
      setQueryInputValue = _useState12[1];

  var _useState13 = (0, _react.useState)([]),
      _useState14 = _slicedToArray(_useState13, 2),
      queryPredictions = _useState14[0],
      setQueryPredictions = _useState14[1];
